...
const TOOL_TEXT = {
  ...
  read_image: () => 'Inspect PNG/JPEG/WebP/GIF directly. For visual work, read related independent views concurrently in one small batch; if many frames exist, prefer a contact sheet/strip. Scan the whole batch and inventory visible defects before focusing. Use images before code/proxy metrics and inspect comparable after evidence. Paths may omit extensions; oversized images downscale automatically.',
