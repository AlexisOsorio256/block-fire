...
const TOOL_TEXT = {
  ...
  read_image: () => 'Inspect PNG/JPEG/WebP/GIF directly. Read related independent views concurrently in one small batch; if many frames exist, prefer a contact sheet/strip. Scan the whole batch and inventory visible defects before focusing. For visual questions use images before inferring from code, geometry or proxy metrics; inspect comparable after evidence. Paths may omit extensions; oversized images downscale automatically.',
