...
const TOOL_TEXT = {
  ...
  read_image: () => 'Read a PNG/JPEG/WebP/GIF file and return the image itself. Paths without an extension work: the format is detected from content, so attachment paths can be passed as-is. Independent files may be read concurrently in small batches. Oversized images are downscaled before the next request — use this tool instead of building thumbnails. Requires a model that accepts image input.',
