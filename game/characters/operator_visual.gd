...
## `grip` y `foregrip` están en espacio del montaje (+Z cañón); el
...
static var WEAPON_CONFIG := {
	"rifle": {
		...
		"length": 0.86,
		"pivot": Vector3(0.0, -0.093478, -0.196304),
		"asset_rot": Vector3(0.0, 0.0, 0.0),
		"ready": Vector3(-0.12, -0.06, 0.13),
		"aim": Vector3(-0.12, -0.025, 0.16),
		"grip": Vector3(0.0, 0.065435, 0.028043),
		"grip_wrist": Vector3(-0.035, -0.025, -0.055),
		"wrist_rot": Vector3(0.0, 0.0, 0.0),
		# Underside of the rifle handguard, measured in the normalized mesh.
		"foregrip": Vector3(0.0, 0.163587, 0.261739),
		"support_wrist": Vector3(0.040, -0.025, -0.065),
		"muzzle": Vector3(0.0, 0.0, 0.626304),
	},
	"pistol": {
		...
		"grip": Vector3(0.0, 0.005, -0.01),
		"grip_wrist": Vector3(-0.035, -0.025, -0.055),
		"wrist_rot": Vector3(0.0, 0.0, 0.0),
		"foregrip": Vector3(-0.025, 0.005, -0.005),
	...
	"shotgun": {
		...
		"length": 0.90,
		"pivot": Vector3(-0.226286, 0.085714, 0.0),
		"asset_rot": Vector3(0.0, -90.0, 0.0),
		"ready": Vector3(-0.10, -0.06, 0.14),
		"aim": Vector3(-0.10, 0.05, 0.16),
		"grip": Vector3(0.0, 0.047143, 0.06),
		"grip_wrist": Vector3(-0.035, -0.025, -0.055),
		"wrist_rot": Vector3(0.0, 0.0, 0.0),
		"foregrip": Vector3(0.0, 0.072857, 0.257143),
		"support_wrist": Vector3(0.040, -0.025, -0.065),
		"reload_path_scale": Vector3(1.0, 0.75, 1.0),
		"muzzle": Vector3(0.0, 0.0, 0.651429),
	},
	"smg": {
		...
		"length": 0.54,
		"pivot": Vector3(0.0, -0.082742, -0.024387),
		"asset_rot": Vector3(0.0, 180.0, 0.0),
		"ready": Vector3(-0.12, -0.04, 0.34),
		"aim": Vector3(-0.12, -0.035, 0.36),
		"grip": Vector3(0.0, 0.087097, -0.087097),
		"grip_wrist": Vector3(-0.035, -0.025, -0.055),
		"wrist_rot": Vector3(0.0, 0.0, 0.0),
		"foregrip": Vector3(0.0, 0.113226, 0.047903),
		"support_wrist": Vector3(0.040, -0.025, -0.065),
		"reload_path_scale": Vector3(1.0, 0.85, 0.6),
		"muzzle": Vector3(0.0, 0.0, 0.130645),
	},
}
